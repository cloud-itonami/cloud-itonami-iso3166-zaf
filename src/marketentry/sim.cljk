...
(defn -main [& _]
  (let [db (store/seed-db)
    ...
    (println "== jurisdiction/assess eng-4 (sets up za-presence-missing) ==")
    ...
    (println "== filing/submit eng-4 (za-presence-missing -> HARD hold) ==")
    (println (exec-op actor "t9" {:op :filing/submit :subject "eng-4"} operator))

    (println "== jurisdiction/assess eng-5 (sets up cipc-unverified) ==")
    ...
    (println "== filing/submit eng-5 (cipc-unverified -> HARD hold) ==")
