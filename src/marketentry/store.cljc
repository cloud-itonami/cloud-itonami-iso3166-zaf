(ns marketentry.store
  "SSoT for the ZAF market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems ZA" :portal "eTender/CSD"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-za-presence? true :has-za-presence? true
             :requires-cipc? true :cipc-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ZAF" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "eTender/CSD"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-za-presence? true :has-za-presence? true
             :requires-cipc? true :cipc-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "eTender/CSD"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "ZAF" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "eTender/CSD"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-za-presence? true :has-za-presence? false
             :requires-cipc? true :cipc-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ZAF" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "eTender/CSD"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-za-presence? true :has-za-presence? true
             :requires-cipc? true :cipc-verified? false
             :drafted? false :submitted? false
             :jurisdiction "ZAF" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "eTender/CSD"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-za-presence? has-za-presence?
                               requires-cipc? cipc-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-za-presence?)  (assoc :engagement/requires-za-presence? requires-za-presence?)
    (some? has-za-presence?)       (assoc :engagement/has-za-presence? has-za-presence?)
    (some? requires-cipc?)    (assoc :engagement/requires-cipc? requires-cipc?)
    (some? cipc-verified?)    (assoc :engagement/cipc-verified? cipc-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-za-presence? :engagement/has-za-presence?
   :engagement/requires-cipc? :engagement/cipc-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-za-presence? (boolean (:engagement/requires-za-presence? m))
     :has-za-presence? (boolean (:engagement/has-za-presence? m))
     :requires-cipc? (boolean (:engagement/requires-cipc? m))
     :cipc-verified? (boolean (:engagement/cipc-verified? m))
