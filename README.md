# cloud-itonami-iso3166-zaf

Open ISO 3166 Blueprint for **ZAF**: South Africa.
...
tax registration, and local-content rules in South Africa, so the operator
...
- **Not the government of South Africa.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to South African-licensed counsel
...
(ISO 3166 `ZAF`). Required capabilities:
